...
_TONECHANGE = DESCRIPTOR.message_types_by_name['ToneChange']
_TONECHANGE_STABILITYSTATS = _TONECHANGE.nested_types_by_name['StabilityStats']
_TONEMATCHOPTIONS = DESCRIPTOR.message_types_by_name['ToneMatchOptions']
_CLIPMASKOPTIONS = DESCRIPTOR.message_types_by_name['ClipMaskOptions']
_TONEESTIMATIONOPTIONS = DESCRIPTOR.message_types_by_name['ToneEstimationOptions']
_TONEESTIMATIONOPTIONS_GAINBIASBOUNDS = _TONEESTIMATIONOPTIONS.nested_types_by_name['GainBiasBounds']
_TONEMATCH = DESCRIPTOR.message_types_by_name['ToneMatch']
_PATCHTONEMATCH = DESCRIPTOR.message_types_by_name['PatchToneMatch']
_TONECHANGE_TYPE = _TONECHANGE.enum_types_by_name['Type']
_TONEESTIMATIONOPTIONS_DOWNSAMPLEMODE = _TONEESTIMATIONOPTIONS.enum_types_by_name['DownsampleMode']
ToneChange = _reflection.GeneratedProtocolMessageType('ToneChange', (_message.Message,), {

  'StabilityStats' : _reflection.GeneratedProtocolMessageType('StabilityStats', (_message.Message,), {
...
ToneMatchOptions = _reflection.GeneratedProtocolMessageType('ToneMatchOptions', (_message.Message,), {
...
ClipMaskOptions = _reflection.GeneratedProtocolMessageType('ClipMaskOptions', (_message.Message,), {
...
ToneEstimationOptions = _reflection.GeneratedProtocolMessageType('ToneEstimationOptions', (_message.Message,), {

  'GainBiasBounds' : _reflection.GeneratedProtocolMessageType('GainBiasBounds', (_message.Message,), {
...
ToneMatch = _reflection.GeneratedProtocolMessageType('ToneMatch', (_message.Message,), {
...
PatchToneMatch = _reflection.GeneratedProtocolMessageType('PatchToneMatch', (_message.Message,), {
