...
_BOXDETECTOROPTIONS = DESCRIPTOR.message_types_by_name['BoxDetectorOptions']
_BOXDETECTOROPTIONS_IMAGEQUERYSETTINGS = _BOXDETECTOROPTIONS.nested_types_by_name['ImageQuerySettings']
_BOXDETECTORINDEX = DESCRIPTOR.message_types_by_name['BoxDetectorIndex']
_BOXDETECTORINDEX_BOXENTRY = _BOXDETECTORINDEX.nested_types_by_name['BoxEntry']
_BOXDETECTORINDEX_BOXENTRY_FRAMEENTRY = _BOXDETECTORINDEX_BOXENTRY.nested_types_by_name['FrameEntry']
_BOXDETECTOROPTIONS_INDEXTYPE = _BOXDETECTOROPTIONS.enum_types_by_name['IndexType']
BoxDetectorOptions = _reflection.GeneratedProtocolMessageType('BoxDetectorOptions', (_message.Message,), {

  'ImageQuerySettings' : _reflection.GeneratedProtocolMessageType('ImageQuerySettings', (_message.Message,), {
...
BoxDetectorIndex = _reflection.GeneratedProtocolMessageType('BoxDetectorIndex', (_message.Message,), {

  'BoxEntry' : _reflection.GeneratedProtocolMessageType('BoxEntry', (_message.Message,), {

    'FrameEntry' : _reflection.GeneratedProtocolMessageType('FrameEntry', (_message.Message,), {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _BOXDETECTOROPTIONS._serialized_end=764
  _BOXDETECTOROPTIONS_IMAGEQUERYSETTINGS._serialized_start=566
  _BOXDETECTOROPTIONS_IMAGEQUERYSETTINGS._serialized_end=713
  _BOXDETECTOROPTIONS_INDEXTYPE._serialized_start=715
  _BOXDETECTOROPTIONS_INDEXTYPE._serialized_end=764
  _BOXDETECTORINDEX._serialized_start=767
  _BOXDETECTORINDEX._serialized_end=1054
  _BOXDETECTORINDEX_BOXENTRY._serialized_start=845
  _BOXDETECTORINDEX_BOXENTRY._serialized_end=1054
  _BOXDETECTORINDEX_BOXENTRY_FRAMEENTRY._serialized_start=927
  _BOXDETECTORINDEX_BOXENTRY_FRAMEENTRY._serialized_end=1054
