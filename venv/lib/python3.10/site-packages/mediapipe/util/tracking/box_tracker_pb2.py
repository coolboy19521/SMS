...
_BOXTRACKEROPTIONS = DESCRIPTOR.message_types_by_name['BoxTrackerOptions']
_TIMEDBOXPROTO = DESCRIPTOR.message_types_by_name['TimedBoxProto']
_TIMEDBOXPROTOLIST = DESCRIPTOR.message_types_by_name['TimedBoxProtoList']
BoxTrackerOptions = _reflection.GeneratedProtocolMessageType('BoxTrackerOptions', (_message.Message,), {
...
TimedBoxProto = _reflection.GeneratedProtocolMessageType('TimedBoxProto', (_message.Message,), {
...
TimedBoxProtoList = _reflection.GeneratedProtocolMessageType('TimedBoxProtoList', (_message.Message,), {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _BOXTRACKEROPTIONS._serialized_end=359
  _TIMEDBOXPROTO._serialized_start=362
  _TIMEDBOXPROTO._serialized_end=657
  _TIMEDBOXPROTOLIST._serialized_start=659
  _TIMEDBOXPROTOLIST._serialized_end=717
