...
_FRAMESELECTIONTIMESTAMP = DESCRIPTOR.message_types_by_name['FrameSelectionTimestamp']
_FRAMESELECTIONRESULT = DESCRIPTOR.message_types_by_name['FrameSelectionResult']
_FRAMESELECTIONCRITERION = DESCRIPTOR.message_types_by_name['FrameSelectionCriterion']
_FRAMESELECTIONOPTIONS = DESCRIPTOR.message_types_by_name['FrameSelectionOptions']
FrameSelectionTimestamp = _reflection.GeneratedProtocolMessageType('FrameSelectionTimestamp', (_message.Message,), {
...
FrameSelectionResult = _reflection.GeneratedProtocolMessageType('FrameSelectionResult', (_message.Message,), {
...
FrameSelectionCriterion = _reflection.GeneratedProtocolMessageType('FrameSelectionCriterion', (_message.Message,), {
...
FrameSelectionOptions = _reflection.GeneratedProtocolMessageType('FrameSelectionOptions', (_message.Message,), {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _FRAMESELECTIONTIMESTAMP._serialized_start=214
  _FRAMESELECTIONTIMESTAMP._serialized_end=315
  _FRAMESELECTIONRESULT._serialized_start=318
  _FRAMESELECTIONRESULT._serialized_end=516
  _FRAMESELECTIONCRITERION._serialized_start=519
  _FRAMESELECTIONCRITERION._serialized_end=739
  _FRAMESELECTIONOPTIONS._serialized_start=741
  _FRAMESELECTIONOPTIONS._serialized_end=844
