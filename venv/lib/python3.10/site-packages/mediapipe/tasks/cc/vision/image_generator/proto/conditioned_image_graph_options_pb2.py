...
_CONDITIONEDIMAGEGRAPHOPTIONS = DESCRIPTOR.message_types_by_name['ConditionedImageGraphOptions']
_CONDITIONEDIMAGEGRAPHOPTIONS_FACECONDITIONTYPEOPTIONS = _CONDITIONEDIMAGEGRAPHOPTIONS.nested_types_by_name['FaceConditionTypeOptions']
_CONDITIONEDIMAGEGRAPHOPTIONS_EDGECONDITIONTYPEOPTIONS = _CONDITIONEDIMAGEGRAPHOPTIONS.nested_types_by_name['EdgeConditionTypeOptions']
_CONDITIONEDIMAGEGRAPHOPTIONS_DEPTHCONDITIONTYPEOPTIONS = _CONDITIONEDIMAGEGRAPHOPTIONS.nested_types_by_name['DepthConditionTypeOptions']
ConditionedImageGraphOptions = _reflection.GeneratedProtocolMessageType('ConditionedImageGraphOptions', (_message.Message,), {

  'FaceConditionTypeOptions' : _reflection.GeneratedProtocolMessageType('FaceConditionTypeOptions', (_message.Message,), {
    'DESCRIPTOR' : _CONDITIONEDIMAGEGRAPHOPTIONS_FACECONDITIONTYPEOPTIONS,
    '__module__' : 'mediapipe.tasks.cc.vision.image_generator.proto.conditioned_image_graph_options_pb2'
    # @@protoc_insertion_point(class_scope:mediapipe.tasks.vision.image_generator.proto.ConditionedImageGraphOptions.FaceConditionTypeOptions)
    })
  ,

  'EdgeConditionTypeOptions' : _reflection.GeneratedProtocolMessageType('EdgeConditionTypeOptions', (_message.Message,), {
    'DESCRIPTOR' : _CONDITIONEDIMAGEGRAPHOPTIONS_EDGECONDITIONTYPEOPTIONS,
    '__module__' : 'mediapipe.tasks.cc.vision.image_generator.proto.conditioned_image_graph_options_pb2'
    # @@protoc_insertion_point(class_scope:mediapipe.tasks.vision.image_generator.proto.ConditionedImageGraphOptions.EdgeConditionTypeOptions)
    })
  ,

  'DepthConditionTypeOptions' : _reflection.GeneratedProtocolMessageType('DepthConditionTypeOptions', (_message.Message,), {
    'DESCRIPTOR' : _CONDITIONEDIMAGEGRAPHOPTIONS_DEPTHCONDITIONTYPEOPTIONS,
    '__module__' : 'mediapipe.tasks.cc.vision.image_generator.proto.conditioned_image_graph_options_pb2'
    # @@protoc_insertion_point(class_scope:mediapipe.tasks.vision.image_generator.proto.ConditionedImageGraphOptions.DepthConditionTypeOptions)
    })
  ,
  'DESCRIPTOR' : _CONDITIONEDIMAGEGRAPHOPTIONS,
  '__module__' : 'mediapipe.tasks.cc.vision.image_generator.proto.conditioned_image_graph_options_pb2'
  # @@protoc_insertion_point(class_scope:mediapipe.tasks.vision.image_generator.proto.ConditionedImageGraphOptions)
  })
_sym_db.RegisterMessage(ConditionedImageGraphOptions)
_sym_db.RegisterMessage(ConditionedImageGraphOptions.FaceConditionTypeOptions)
_sym_db.RegisterMessage(ConditionedImageGraphOptions.EdgeConditionTypeOptions)
_sym_db.RegisterMessage(ConditionedImageGraphOptions.DepthConditionTypeOptions)
