...
_HOLISTICLANDMARKERGRAPHOPTIONS = DESCRIPTOR.message_types_by_name['HolisticLandmarkerGraphOptions']
HolisticLandmarkerGraphOptions = _reflection.GeneratedProtocolMessageType('HolisticLandmarkerGraphOptions', (_message.Message,), {
  'DESCRIPTOR' : _HOLISTICLANDMARKERGRAPHOPTIONS,
  '__module__' : 'mediapipe.tasks.cc.vision.holistic_landmarker.proto.holistic_landmarker_graph_options_pb2'
  # @@protoc_insertion_point(class_scope:mediapipe.tasks.vision.holistic_landmarker.proto.HolisticLandmarkerGraphOptions)
  })
_sym_db.RegisterMessage(HolisticLandmarkerGraphOptions)
