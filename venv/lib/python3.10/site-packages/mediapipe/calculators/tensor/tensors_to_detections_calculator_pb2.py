...
_TENSORSTODETECTIONSCALCULATOROPTIONS_TENSORMAPPING = _TENSORSTODETECTIONSCALCULATOROPTIONS.nested_types_by_name['TensorMapping']
_TENSORSTODETECTIONSCALCULATOROPTIONS_BOXBOUNDARIESINDICES = _TENSORSTODETECTIONSCALCULATOROPTIONS.nested_types_by_name['BoxBoundariesIndices']
_TENSORSTODETECTIONSCALCULATOROPTIONS_BOXFORMAT = _TENSORSTODETECTIONSCALCULATOROPTIONS.enum_types_by_name['BoxFormat']
TensorsToDetectionsCalculatorOptions = _reflection.GeneratedProtocolMessageType('TensorsToDetectionsCalculatorOptions', (_message.Message,), {
  ...
  'TensorMapping' : _reflection.GeneratedProtocolMessageType('TensorMapping', (_message.Message,), {
  ...
  'BoxBoundariesIndices' : _reflection.GeneratedProtocolMessageType('BoxBoundariesIndices', (_message.Message,), {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _TENSORSTODETECTIONSCALCULATOROPTIONS._serialized_end=1422
  _TENSORSTODETECTIONSCALCULATOROPTIONS_TENSORMAPPING._serialized_start=985
  _TENSORSTODETECTIONSCALCULATOROPTIONS_TENSORMAPPING._serialized_end=1159
  _TENSORSTODETECTIONSCALCULATOROPTIONS_BOXBOUNDARIESINDICES._serialized_start=1161
  _TENSORSTODETECTIONSCALCULATOROPTIONS_BOXBOUNDARIESINDICES._serialized_end=1251
  _TENSORSTODETECTIONSCALCULATOROPTIONS_BOXFORMAT._serialized_start=1253
  _TENSORSTODETECTIONSCALCULATOROPTIONS_BOXFORMAT._serialized_end=1311
