...
_RATIONALFACTORRESAMPLECALCULATOROPTIONS = DESCRIPTOR.message_types_by_name['RationalFactorResampleCalculatorOptions']
_RATIONALFACTORRESAMPLECALCULATOROPTIONS_RESAMPLERRATIONALFACTOROPTIONS = _RATIONALFACTORRESAMPLECALCULATOROPTIONS.nested_types_by_name['ResamplerRationalFactorOptions']
RationalFactorResampleCalculatorOptions = _reflection.GeneratedProtocolMessageType('RationalFactorResampleCalculatorOptions', (_message.Message,), {

  'ResamplerRationalFactorOptions' : _reflection.GeneratedProtocolMessageType('ResamplerRationalFactorOptions', (_message.Message,), {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _RATIONALFACTORRESAMPLECALCULATOROPTIONS._serialized_end=551
  _RATIONALFACTORRESAMPLECALCULATOROPTIONS_RESAMPLERRATIONALFACTOROPTIONS._serialized_start=365
  _RATIONALFACTORRESAMPLECALCULATOROPTIONS_RESAMPLERRATIONALFACTOROPTIONS._serialized_end=453
