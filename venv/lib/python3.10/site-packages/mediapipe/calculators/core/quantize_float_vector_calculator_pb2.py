...
_QUANTIZEFLOATVECTORCALCULATOROPTIONS = DESCRIPTOR.message_types_by_name['QuantizeFloatVectorCalculatorOptions']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _QUANTIZEFLOATVECTORCALCULATOROPTIONS._serialized_end=310
