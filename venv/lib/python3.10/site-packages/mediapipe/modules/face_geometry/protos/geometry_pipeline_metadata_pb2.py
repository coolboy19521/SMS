...
_INPUTSOURCE = DESCRIPTOR.enum_types_by_name['InputSource']
...
_WEIGHTEDLANDMARKREF = DESCRIPTOR.message_types_by_name['WeightedLandmarkRef']
_GEOMETRYPIPELINEMETADATA = DESCRIPTOR.message_types_by_name['GeometryPipelineMetadata']
WeightedLandmarkRef = _reflection.GeneratedProtocolMessageType('WeightedLandmarkRef', (_message.Message,), {
...
GeometryPipelineMetadata = _reflection.GeneratedProtocolMessageType('GeometryPipelineMetadata', (_message.Message,), {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _INPUTSOURCE._serialized_start=441
  _INPUTSOURCE._serialized_end=524
  _WEIGHTEDLANDMARKREF._serialized_start=154
  _WEIGHTEDLANDMARKREF._serialized_end=212
  _GEOMETRYPIPELINEMETADATA._serialized_start=215
  _GEOMETRYPIPELINEMETADATA._serialized_end=439
